...
@Ignore
public class LogoutGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(LogoutGetHandlerTest.class);
    ...
    @Test
    public void testLogoutGetHandlerTest() throws ClientException {

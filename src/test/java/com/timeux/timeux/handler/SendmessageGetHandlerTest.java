...
package com.timeux.timeux.handler;
...
@Ignore
public class SendmessageGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(SendmessageGetHandlerTest.class);
    ...
    @Test
    public void testSendmessageGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/sendmessage?message=mKPbClB";

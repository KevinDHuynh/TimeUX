...
@Ignore
public class SendreminderGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(SendreminderGetHandlerTest.class);
    ...
    @Test
    public void testSendreminderGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/sendreminder";

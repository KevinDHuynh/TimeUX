...
@Ignore
public class StatusGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(StatusGetHandlerTest.class);
    ...
    @Test
    public void testStatusGetHandlerTest() throws ClientException {

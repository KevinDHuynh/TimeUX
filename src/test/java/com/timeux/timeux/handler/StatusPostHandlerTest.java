...
@Ignore
public class StatusPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(StatusPostHandlerTest.class);
    ...
    @Test
    public void testStatusPostHandlerTest() throws ClientException {
